package com.jeongmin.product.service;
...
import com.jeongmin.product.repository.CategoryRepository;
...
public class CategoryServiceImpl implements CategoryService {
	...
	public List<CategoryDTO> getList() {
		...
		List<CategoryDTO> categoryList = entityList.stream()
				.map(entity -> CategoryDTO.builder().categoryId(entity.getCategoryId())
						.categoryName(entity.getCategoryName()).description(entity.getDescription())
