...
public class CategoryRepositoryTest {
	 ...
	 * IntStream.rangeClosed(1, 100).forEach(i -> { Category category = new
	 * Category(); category.setCategoryName("Category" + i);
	 * category.setDescription("Category 설명" + i);
	 * 
	 * // 영속화(메모리의 엔티티 매니저의 관리 대상이 됨) categoryRepository.save(category); });
	 * 
